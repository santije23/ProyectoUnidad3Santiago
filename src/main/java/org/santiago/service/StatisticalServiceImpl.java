...
// Implementacion de metodos estadisticos
public class StatisticalServiceImpl implements StatisticalService{
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el promedio de la edad
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el promedio del estrato
    // de los que son desempleados
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el promedio de numero de hijos
    // de los que son desempleados
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el promedio del salario
    // de los que son desempleados
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, la moda del nivel educacional
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, la media de la edad
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, la media del estrato
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, la media del numero de hijos
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el porcentaje de hombres
    @Override
    ...
    // El siguiente metodo permite calcular respecto al total de personas, el porcentaje de mujeres
    @Override
